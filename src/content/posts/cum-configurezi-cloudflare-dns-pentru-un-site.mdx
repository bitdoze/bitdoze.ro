...
description: "Ghid de configurare DNS în Cloudflare: înregistrări A, AAAA, CNAME, MX și cum le legi de domeniu și hosting, pas cu pas."
date: 2026-04-02
...
În ~20 de minute legi domeniul de hosting în Cloudflare: înregistrări A, CNAME, MX și TXT, fiecare la locul ei, ca site-ul și emailul să meargă din prima.

Ai nevoie doar de un domeniu adăugat deja în contul Cloudflare, cu nameserverele schimbate la registrator. În ghidul ăsta trecem prin fiecare tip de înregistrare pe care o folosești în practică, cum o adaugi și la ce trebuie să fii atent ca totul să funcționeze corect.
...
## Ce urmează după configurarea DNS

Cu DNS-ul și SSL-ul puse corect, ai fundația gata — de aici te ocupi de conținut, viteză și SEO. Dacă vrei să fii sigur că n-ai ratat nimic (un MX pus pe Proxied sau un SPF lipsă te costă emailuri ajunse în spam), aruncăm noi o privire peste zona ta înainte să dai drumul site-ului.

<Button
  text="Cere verificare DNS"
  link="/contact"
  variant="solid"
  color="blue"
  icon="arrow-right"
