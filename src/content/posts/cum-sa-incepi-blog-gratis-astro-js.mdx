---
title: "Cum începi un blog gratis cu Astro și Cloudflare"
description: "Ghid pas cu pas: creează un blog cu Astro JS și publică-l gratuit pe Cloudflare Pages. Fără hosting, fără WordPress."
date: 2026-04-02
...
Un blog rapid, cu 0 €/lună costuri de hosting: îl construiești cu [Astro JS](https://astro.build/) și îl publici pe Cloudflare Pages. Fără WordPress, fără bază de date, fără costuri ascunse.

În ~30 de minute parcurgi tot procesul: cont GitHub, Node.js, primul proiect Astro, push pe Git și conectarea la Cloudflare Pages, până la primul articol publicat. (O să te oprești să te joci cu culorile — știm cu toții.)
...
Dacă te blochezi la setup, vrei un design care nu arată a temă gratuită sau ai conținut de mutat de pe WordPress, facem noi partea tehnică în 1–2 zile: blogul configurat, publicat și gata de scris.

<Button
  text="Cere setup blog"
  link="/contact"
  variant="solid"
  color="blue"
  icon="arrow-right"
